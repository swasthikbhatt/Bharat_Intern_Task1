<?php 
  ...
  {
    include "config.php";
    # mysqli_real_escape_string(Connection variable, Field to be checked)
    $fname    = mysqli_real_escape_string($conn, $_POST['fname']);
    $lname    = mysqli_real_escape_string($conn, $_POST['lname']);
    $user     = mysqli_real_escape_string($conn, $_POST['user']);
    # md5 function is used to encrypte the password
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-3 col-md-6">
                    <!-- Form Start -->
                    <!-- $_SERVER['PHP_SELF'] : means action is on the same page, i.e add-user.php -->
