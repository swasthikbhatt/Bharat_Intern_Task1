              ...
              <div class="col-md-12">
                <?php
                  ...
                  if($_SESSION["user_role"] == '1')
                  {
                    ...
                    /* 
                      we want category_name and username which is not there is post table
                      but we have category_number and author in post table as foreign key
                      so now perform left join.
                    */
